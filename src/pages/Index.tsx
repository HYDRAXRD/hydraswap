...
{ href: "https://instagram.com/hydraxrd", icon: (
  <svg viewBox="0 0 24 24" className="w-4 h-4 text-gray-400">
    <circle cx="12" cy="12" r="7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/>
    <circle cx="12" cy="8.5" r="2.5" fill="none" stroke="currentColor" strokeWidth="1.8"/>
